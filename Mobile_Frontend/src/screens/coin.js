  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} style={{ backgroundColor: '#F5F5F5' }}>
        ...
        <ActivityRow title="Waste added to the plastic bin" date="2025-11-22" points="+15" />
        <ActivityRow title="Waste added to the organic bin" date="2025-10-24" points="+25" />
        <ActivityRow title="Waste added to the glass bin" date="2025-10-24" points="+10" />
        <ActivityRow title="Waste added to the organic bin" date="2025-10-17" points="+30" />
